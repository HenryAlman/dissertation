...
class CustomBayesianOptimizationScheduler(Scheduler):
    ...
    Raises:
        TypeError: Some emitters are not CustomBayesianOptimizationEmitter.
    ...
    def __init__(
        self,
        archive: GridArchive,
        emitters: Sequence[CustomBayesianOptimizationEmitter],
        ...
        *,
        ...
        # Checks that all emitters are CustomBayesianOptimizationEmitter and have the same
        # upscale schedule.
        this_upscale_schedule = None
        for i, e in enumerate(emitters):
            if not isinstance(e, CustomBayesianOptimizationEmitter):
                raise TypeError(
                    "All emitters must be of type CustomBayesianOptimizationEmitter, "
    ...
    def ask_dqd(self) -> None:
        raise NotImplementedError(
            "ask_dqd() is not supported by CustomBayesianOptimizationScheduler."
        )
    ...
    def tell_dqd(
        ...
        **fields: ArrayLike | None,
        ...
        raise NotImplementedError(
            "tell_dqd() is not supported by CustomBayesianOptimizationScheduler."
        )
