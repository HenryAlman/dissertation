...
def mujoco_main(
    ...
    algorithm_params = {"search_nrestarts": 10, "entropy_ejie": False, "make_prediction_archive": True, "upscale_schedule": ((4,8), (8,16), (12,25))}, # paramater dict for algorithm. See create_scheduler for details per algorithm. Pass in as JSON.
